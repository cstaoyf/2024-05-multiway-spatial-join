...
\myeqn{
    ...
    &\leq& 2c^2\cdot k^3(k-1)^3(n\log n + k \cdot\out)+  \nn\\
    && c^2 \cdot k^3(k-1)^3 \cdot F_{k-2}(n,\out) \nn \\
    &\leq& 3c^3\cdot k^3(k-1)^3(k-2)^3(n\log n + k \cdot\out)+  \nn\\
    && c^3 \cdot k^3(k-1)^3(k-2)^3 \cdot F_{k-3}(n,\out)\nn\\
    &\leq& ... \nn \\
    &\leq& (k-2)c^{k-2}(k!/2)^3(n\log n + k \cdot\out) \nn \\
    && + c^{k-2}(k!/2)^3 \cdot F_{2}(n,\out) \nn \\
    &=& (k-1)c^{k-2}(k!/2)^3(n\log n + k \cdot\out) \nn \\
    &=& O(k\cdot c^k \cdot (k!)^3(n\log n + k \cdot\out)). \nn
}
