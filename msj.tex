...
This paper revisits the {\em multiway spatial join} (MSJ) problem defined as follows. Let $k$ be a constant integer at least 2. The input of the {\em $k$-MSJ problem} comprises $k$ sets --- denoted as $R_1, R_2, ..., R_k$ --- of axis-parallel rectangles\footnote{A rectangle $r$ in 2D space is said to be {\em axis-parallel} if it has the form $r = [x_1, x_2] \times [y_1, y_2]$.} in $\real^2$. The objective is to find all the $k$-tuples $(r_1, r_2, ..., r_k)$ such that
\myitems{
