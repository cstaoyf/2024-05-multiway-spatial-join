...
\extraspacing {\bf Computing the ``d-cross'' Sets.} We are ready explain how to compute $\dcross_H(\bm{t})$ for any $\bm{t} \in \J(R'_1, ..., R'_{k-2})$. By Statement (2) of Lemma~\ref{lmm:hv:type1:cross-r*},
