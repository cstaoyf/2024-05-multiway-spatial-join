...
\extraspacing {\underline{\em Example 5.3.}} For $\bm{t}_1 = (\alpha, h_2', v_1) \in \J(R_1, , H', V)$.
Therefore, $H' = \set{h_2', h_3'}$. It is clear from Figure~\ref{fig:guard}b that $\J(R_1, , H', V)$ has 3 tuples: $\bm{t}_1 = (\alpha, h_2', v_1), \bm{t}_2 = (\alpha, h_3', v_1)$, and $\bm{t}_3 = (\alpha, h_3', v_2)$.
