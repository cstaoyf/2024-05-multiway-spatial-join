...
\contained_{R_{k-2}}(\bm{t})$, or equivalently, whether $r$ covers the intersection point between $\bm{t}[k-2]$ and $\bm{t}[k-1]$; this takes $O(1)$ time. Abort the scan as soon as $r \notin 
