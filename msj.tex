...
\extraspacing {\bf Computing the ``d-cross'' Sets.} We are ready explain how to compute $\dcross_H(\bm{t})$ for any $\bm{t} \in \J(R'_1, ..., R'_{k-2})$. This, in fact, has been made easy by Statement (2) of Lemma~\ref{lmm:hv:type1:cross-r*}. First, identify $r' = \gbot(\bm{t})$ and its top-sliced rectangle $r^*$. Then, scan the segments in $\cross_H(r^*)$
