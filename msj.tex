...
A {\em comparison-based $k$-SJ} algorithm for solving $(n_1, n_2, ..., n_k)$-inputs is a decision tree $\T$ defined as follows. Each internal node $u$ of $\T$ has three child nodes, referred as the {\em left}, {\em middle}, and {\em right} child, respectively. Each node is associated with an {\em instruction} of the form $(i_1, \dim_1, \lambda_1; i_2, \dim_2, \lambda_2)$. Each leaf is associated with an {\em output}, which is defined to be a subset of $[n_1] \times [n_2] \times ... \times [n_k]$.

\vgap

Given an $(n_1, n_2, ..., n_k)$-input, we execute the algorithm from the root of $\T$.
