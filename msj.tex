...
\extraspacing {\bf Category 1.} Fix an arbitrary $i \in [k]$. We now explain how to find all the result tuples $\bm{t} \in \J(R_1, R_2, ..., R_k)$ such that the top-left corner of $B_\bm{t}$ is the top-left corner of $\bm{t}[i]$.
