...
We will first prove $\dcross_H(\bm{t})\subseteq \cross_H(r^*)$. For this purpose, given an arbitrary segment $h \in \dcross_H(\bm{t})$, we will show that $h$ crosses $r^*$. For this purpose, we need to explain why $\xleft(h) < x_1 \le x_2 < \xright(h)$ and $y_h \in [y_1, \maxtop(r')]$.
\begin{itemize}
