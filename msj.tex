...
\extraspacing {\underline{\em Example 4.5.} The two tuples $\bm{t}_1 = (\alpha', \beta_1')$ and $\bm{t}_2 = (\alpha', \beta_2')$ in $\J(R_1',$ $R_2')$ satisfy $\gbot(\bm{t}_1) = \gbot(\bm{t}_2) = \alpha'$. Therefore, $\maxtop(\alpha') = \max\{\ytop(B_{\bm{t}_1}), \ytop(B_{\bm{t}_2})\} = \max\{6, 9.5\} = 9.5$. The top-sliced rectangle of $r'$ is the rectangle $\alpha^*$ in Figure~\ref{fig:hv:type1:ex}d. Rectangles $\beta'_1$ and $\beta'_2$ do not have top-sliced rectangles.
\qed
...
\extraspacing {\underline{\em Example 4.6.}}
\qed
