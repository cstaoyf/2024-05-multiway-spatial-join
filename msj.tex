...
\begin{lemma} \label{lmm:hv:type1:cross-r*}
    ...
    \myenums{
        ...
        \item Consider any $k$-tuple $\bm{t} \in \J(R'_1, ..., R'_{k-2})$. Let $r' = \gbot(\bm{t})$ and $r^*$ be the top-sliced rectangle of $r'$. Then, it must hold that $\dcross_H(\bm{t}) \subseteq \cross_H(r^*)$. Furthermore, if the segments of $\cross_H(r^*)$
    }
\end{lemma}
