...
From the theory perspective, SJs are best understood when $k = 2$, i.e., the {\em pairwise} scenario, where the problem can be solvable in $O(n \log n + \out)$ time by the standard planesweep technique \cite{bcko08}.
