...
These sets have important properties, as proved in Appendix~\ref{app:hv} (recall the notation $\bm{t}[i] = r_i'$ for each $i \in [k-2]$):
...
\begin{lemma} \label{lmm:hv:type1:properties}
    ...
    \myenums{
        ...
        \myenums{
            ...
            \item Let $r_i$ ($i \in [k-2]$) be the full rectangle of $\bm{t}[i']$. Then,
