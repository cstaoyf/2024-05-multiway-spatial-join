...
\noindent {\underline{\em Example 5.2.}} Segment $h_1$ has no left-covering rectangle in $R_2$ and thus has no trimmed segment. Segment $h_2$ has $\beta_2$ and $\beta_3$ as its left-covering rectangles. As the entire $h_2$ is covered by $\beta_2$
\qed
