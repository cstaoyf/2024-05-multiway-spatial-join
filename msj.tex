...
Now, we compute $\cross_H(r^*)$ for each $r^* \in R^*_i$ --- where $\cross_H(r^*)$, defined in \eqref{eqn:cross}, is the set of segments in $H$ crossing $r^*$ --- which is an instance of the find-all-sorted version of Problem $\mathscr{D}$. 
