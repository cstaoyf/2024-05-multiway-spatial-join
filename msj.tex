...
\begin{lemma} \label{lmm:hv:type1:properties}
    ...
    \myenums{
        ...
        \item Consider any a $k$-tuple $(r_1, r_2, ..., r_{k-2}, h, v) \in \J_1$. Let $r'_i$ ($i \in [k-2])$ be the trimmed rectangle of $r_i$, and set $\bm{t} = (r'_1, r'_2, ...,$ $r'_{k-2})$. Then, $\bm{t} \in \J(R_1', R'_2, ..., R'_{k-2})$, $h \in \dcross_H(\bm{t})$, and $v \in \dcross_V(\bm{t})$. 
