...
\extraspacing {\underline{\em Example 5.4.}} For $\bm{t}_1 = (\alpha, h_2', v_1)$, first find the full segment of $h_2'$, which is $h_2$. As $\beta_1$ is the only rectangle in $\contained_{R_2}(\bm{t}_1)$, Line 5 adds tuple $(\alpha, \beta_1, h_2, v_1)$ to $\J_2$. For $\bm{t}_2 = (\alpha, h_3', v_2)$, the full segment of $h_3'$ is $h_3$. As $\contained_{R_2}(\bm{t}_2) = \set{\beta_1, \beta_2, \beta_3}$, Line 5 adds $(\alpha, \beta_1, h_3, v_2)$, $(\alpha, \beta_2, h_3, v_2)$, and $(\alpha, \beta_3, h_3, v_2)$ to $\J_2$. Finally, the processing of $\tm{t}_3 = (\alpha, h_3', v_2)$ adds $(\alpha, \beta_3, h_3, v_2)$ to $\J_2$.
\qed
