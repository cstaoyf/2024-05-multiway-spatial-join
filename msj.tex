...
\myitems{
    ...
    \item {{\bf Cat.\ 2:}} $p$ is not a corner of any of $r_1, ..., r_k$. This means $p$ must be the intersection point between the left edge of some rectangle $r_i$ and the top edge of another rectangle $r_j$, where $i, j \in [k]$ and $i \ne j$.
}
